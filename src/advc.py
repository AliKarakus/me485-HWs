...
#-------------------------------------------------------------------------------------------------#
    def set(self, args):
        ...
        gparser = argparse.ArgumentParser(prog='Gradient',description='Compute Gradient using FVM',
                    epilog='--------------------------------')

        gparser.add_argument('--method', type=str, default='WEIGHTED-LEAST-SQUARES')
        gparser.add_argument('--Correct', type=bool, default=True)
        gparser.add_argument('--Nfields', type=int, default=args.Nfields)
        gparser.add_argument('--dim', type=int, default=args.dim)
        gparser.add_argument('--IC', type = args.IC, default = args.IC)
        gparser.add_argument('--BC', type = args.BC, default = args.BC)
